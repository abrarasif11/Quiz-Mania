...
const Blog = () => {
	...
	<div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
		<h2 className="mb-12 text-4xl font-bold leading-none text-center sm:text-5xl">Question Answer Part</h2>
		<div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
			...
			<details open="">
				<summary className="py-2 outline-none cursor-pointer focus:underline">Write Something About UseRef Hook?</summary>
